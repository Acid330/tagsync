    ...
    public static readonly Dictionary<string, Dictionary<string, string>> CategoryTranslations = new()
{
    ...
    {
        ["gpu"] = new[] {
        "graphics card", "video card", "gpu card", "відеокарта", "видюха", "відіюха", "вiдео карта",
        "гп", "гпу", "гпу карта", "графіка", "графічна карта", "графічний адаптер"},
        ...
        ["motherboard"] = new[] {"mobo", "материнка", "материнська плата", "mother board", "mothercard", "сістемна плата"},
        ["ram"] = new[] {"ram", "ram memory", "оперативка", "озу", "оперативна память", "память"},
